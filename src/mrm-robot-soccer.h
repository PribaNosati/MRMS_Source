...
// public:
// 	ActionSoccerBounce(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer bounce", 1, Board::ID_ANY, ledSign) {}
// };
...
// public:
// 	ActionSoccerBarrierTest(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer barr. test", 1, Board::ID_ANY, ledSign) {}
// };
...
// public:
// 	ActionSoccerCalibrate(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer calibrate", 1, Board::ID_ANY, ledSign) {}
// };
...
// public:
// 	ActionSoccerCatch(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer catch", 0, Board::ID_ANY, ledSign) {}
// };
...
// public:
// 	ActionSoccerGoalApproach(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer approach", 0, Board::ID_ANY, ledSign) {}
// };
...
// public:
// 	ActionSoccerPlay(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer play") {}
// };
...
// public:
// 	ActionSoccerIdle(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer idle", 0, Board::ID_ANY, ledSign) {}
// };

// class ActionSoccerLineAvoid : public ActionBase {
// 	void perform() { ((RobotSoccer*)_robot)->lineAvoid(); }
// public:
// 	ActionSoccerLineAvoid(RobotSoccer* robot, Mrm_8x8a::LEDSign* ledSign = NULL) : ActionBase(robot, "Soccer line avoid", 0, Board::ID_ANY, ledSign) {}
// };
