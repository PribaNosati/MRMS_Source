...
public:
	ActionSoccerBounce(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "bou", "Soccer bounce", 1, Board::ID_ANY, ledSign) {}
};
...
public:
	ActionSoccerBarrierTest(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "bar", "Soccer barr. test", 1, Board::ID_ANY, ledSign) {}
};
...
public:
	ActionSoccerCalibrate(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "clb", "Soccer calibrate", 1, Board::ID_ANY, ledSign) {}
};
...
public:
	ActionSoccerCatch(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "cat", "Soccer catch", 0, Board::ID_ANY, ledSign) {}
};
...
public:
	ActionSoccerGoalApproach(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "apr", "Soccer approach", 0, Board::ID_ANY, ledSign) {}
};
...
public:
	ActionSoccerIdle(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "idl", "Soccer idle", 0, Board::ID_ANY, ledSign) {}
};

class ActionSoccerLineAvoid : public ActionBase {
	void perform() { ((RobotSoccer*)_robot)->lineAvoid(); }
public:
	ActionSoccerLineAvoid(RobotSoccer* robot, LEDSign* ledSign = NULL) : ActionBase(robot, "avo", "Soccer line avoid", 0, Board::ID_ANY, ledSign) {}
};
